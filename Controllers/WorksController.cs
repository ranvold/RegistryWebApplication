...
namespace RegistryWebApplication.Controllers
{
    public class WorksController : Controller
    {
        ...
        {
            ViewData["ClassroomId"] = new SelectList(_context.Classrooms, "ClassroomId", "Number");
        ...
        public async Task<IActionResult> Create([Bind("WorkId,Name,Mark,StudentId,TeacherId,CommissionId,ClassroomId")] Work work)
        {
            ...
            ViewData["ClassroomId"] = new SelectList(_context.Classrooms, "ClassroomId", "Number", work.ClassroomId);
            ViewData["CommissionId"] = new SelectList(_context.Commissions, "CommissionId", "HeadFathersName", work.CommissionId);
            ViewData["StudentId"] = new SelectList(_context.Students, "StudentId", "Email", work.StudentId);
            ViewData["TeacherId"] = new SelectList(_context.Teachers, "TeacherId", "Email", work.TeacherId);
            return View(work);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WorkId,Name,Mark,StudentId,TeacherId,CommissionId,ClassroomId")] Work work)
        {
            if (id != work.WorkId)
            {
                return NotFound();
