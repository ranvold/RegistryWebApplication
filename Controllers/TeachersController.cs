...
namespace RegistryWebApplication.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TeacherId,LastName,FirstName,FathersName,Email")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeacherId,LastName,FirstName,FathersName,Email")] Teacher teacher)
        {
