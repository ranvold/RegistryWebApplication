...
namespace RegistryWebApplication.Controllers
{
    public class CommissionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CommissionId,HeadLastName,HeadFirstName,HeadFathersName")] Commission commission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommissionId,HeadLastName,HeadFirstName,HeadFathersName")] Commission commission)
        {
